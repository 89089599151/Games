...
DEFAULT_DECK = [
    ...
    {"id":"extreme-t-29","type":"truth","category":"Жесть","age":"16+","tags":["соц"],"text":"Какое убеждение или принцип из юности ты неожиданно изменил(а) во взрослом возрасте?"},
    {"id":"extreme-t-30","type":"truth","category":"Жесть","age":"16+","tags":["соц"],"text":"Если бы у тебя был шанс извиниться перед кем-то из прошлого, кто бы это был и за что?"},
    {"id":"extreme-t-31","type":"truth","category":"Жесть","age":"16+","tags":["соц"],"text":"Был ли в твоей жизни момент, когда страх сделал тебя сильнее? Расскажи подробности."},
